...
# do it 5 times
for i in 1:5
    println("Running evaluation iteration: ", i)
    final_eval = evaluate(env, agent; num_episodes=10000, max_steps=100) 
    println("Final evaluation results for iteration ", i, ": ", final_eval)
end
...
results_dir = "results"
agents_dir = "agents"
pomdp_name = "RS2020" # You already defined this, but let's keep it local for clarity
